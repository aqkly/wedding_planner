...
//form open
echo form_open_multipart(base_url('admin/musik/tambah'),$attribut);
?>
...
<div class="row">
	<div class="col-md-12">
		<div class="form-group form-group-lg">
			...
			<input type="text" name="nama_musik" class="form-control" placeholder="Nama Musik" value="<?= set_value('nama_musik') ?>" required>
		</div>
	</div>
</div>
