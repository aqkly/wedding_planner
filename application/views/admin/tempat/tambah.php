...
//form open
echo form_open_multipart(base_url('admin/tempat/tambah'),$attribut);
?>
...
<div class="row">
	<div class="col-md-12">
		<div class="form-group form-group-lg">
			...
			<input type="text" name="nama_lokasi" class="form-control" placeholder="Nama Venue" value="<?= set_value('nama_lokasi') ?>" required>
		</div>
	</div>
</div>
...
<div class="row">
	<div class="col-md-12">
		<div class="form-group form-group-lg">
			<label>ALAMAT</label>
			<textarea required name="alamat" class="form-control" placeholder="Alamat"><?= set_value('alamat') ?></textarea>
		</div>
	</div>
</div>
