...
//form open
echo form_open_multipart(base_url('admin/tema/tambah'),$attribut);
?>
...
<div class="row">
	<div class="col-md-12">
		<div class="form-group form-group-lg">
			...
			<input type="text" name="nama_tema" class="form-control" placeholder="Nama Tema" value="<?= set_value('nama_tema') ?>" required>
		</div>
	</div>
</div>
