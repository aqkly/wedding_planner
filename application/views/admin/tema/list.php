...
<p>
  <a href="<?= base_url('admin/tema/tambah') ?>" title="Tambah Data" class="btn btn-success">
  ...
  <tbody>
    ...
    ?>
	    <tr>
	      ...
	      <td><?= $b->deskripsi ?></td>
	      <td>
	      	<a href="<?= base_url('admin/tema/edit/'.$b->id) ?>" title="Edit Barang" class="btn btn-warning btn-xs">
