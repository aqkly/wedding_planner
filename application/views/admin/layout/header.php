 ...
 ?>
  <header class="main-header">
    ...
    <a href="<?= base_url('admin/dasbor') ?>" class="logo">
      ...
      <span class="logo-mini"><b>WEDDING</b></span>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?= base_url() ?>assets/admin/dist/img/orang.png" class="user-image" alt="User Image">
              <span class="hidden-xs"><?= $user_aktif->username ?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="<?= base_url() ?>assets/admin/dist/img/orang.png" class="img-circle" alt="User Image">

                <p>
                  <?= $user_aktif->username ?> - <?= $user_aktif->akses_level ?>
