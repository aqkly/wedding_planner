...
<p>
  <a href="<?= base_url('admin/photo/tambah') ?>" title="Tambah Data" class="btn btn-success">
  ...
  <tbody>
    ...
    ?>
	    <tr>
	      ...
	      <td><?= $b->deskripsi ?></td>
	      <td>
	      	<a href="<?= base_url('admin/photo/edit/'.$b->id) ?>" title="Edit Photo" class="btn btn-warning btn-xs">
