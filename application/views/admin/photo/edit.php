...
//form open
echo form_open_multipart(base_url('admin/photo/edit/'.$photo->id),$attribut);
?>
...
<div class="row">
	<div class="col-md-12">
		<div class="form-group form-group-lg">
			<label>HARGA</label>
			<input type="number" step="any" name="harga" class="form-control" placeholder="Harga" value="<?= $photo->harga ?>" required>
		</div>
	</div>	
</div>
...
<div class="row">
	<div class="col-md-12">
		<div class="form-group form-group-lg">
			...
			<textarea required name="deskripsi" class="form-control" placeholder="Deskripsi"><?=$photo->deskripsi ?></textarea>
		</div>
	</div>
</div>
